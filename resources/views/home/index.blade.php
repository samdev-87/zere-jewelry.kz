                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="slider_content">
                            ...
                            <a class="button" href="#">сатып алу</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row ">
                <div class="col-lg-4 col-md-6">
                    <div class="single_banner">
                        <div class="banner_thumb">
                            <a href="#"><img src="{{ asset('img/bg/banner1.jpg') }}" alt=""></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_banner">
                        <div class="banner_thumb">
                            <a href="#"><img src="{{ asset('img/bg/banner2.jpg') }}" alt=""></a>
                            <div class="banner_content">
                                <p>Ерекше Дизайны</p>
                                <h2>Класс Түрі</h2>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_banner bottom">
                        <div class="banner_thumb">
                            <a href="#"><img src="{{ asset('img/bg/banner3.jpg') }}" alt=""></a>
                            <div class="banner_content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="messages_info">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. <a href="#">Alias, quibusdam.</a></p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="product_area">
                        <div class="product_tab_button">
                            <ul class="nav" role="tablist">
                                ...
                                <li>
                                    <a data-bs-toggle="tab" href="#arrivals" role="tab"
                                                    ...
                                                    <div class="product_thumb">
                                                        ...
                                                        <div class="quick_button">
                                                            <a href="#" data-bs-toggle="modal"
                                                               ...
                                                               data-original-title="quick view"> быстрый просмотр</a>
                                                        </div>
                                                    </div>
                                                    <div class="product_content">
                                                        <div class="tag_cate">
                                                            <a href="#">{{ $product->catalog->name }}</a>
                                                        </div>
                                                            ...
                                                            <div class="action_links">
                                                                <ul>
                                                                    ...
                                                                    <li class="add_to_cart">
                                                                        <a href="{{ route('cart.add', ['id' => $product->id]) }}" title="add to cart">add to cart</a>
                                                                    </li>
                                                                    <li>
